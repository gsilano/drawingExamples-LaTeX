...
\begin{figure}[h]
	\begin{center}
		\scalebox{0.6}{
			\begin{tikzpicture}[rotor/.style={inner sep=3pt,outer sep=0,fill opacity=0.3,minimum 
				width=2cm,circle}, crossline/.style={gray,line width=3pt,opacity=0.5,line 
				cap=round}]
			
			%%%%% FIRST MULTI-ROTOR
			
			% cross line
			\draw[crossline] (-4,-2.2) -- (-4,2.2);
			\draw[crossline] (-6.2,0) -- (-1.8,0);
			
			% Body reference system
			\draw[-latex, green, line width=1.25pt] (-4,0) -- (-4.75,-0.75)	node[below]{$y$};
			\draw[-latex, blue, line width=1.25pt] (-4,0) -- (-4.75,0.75) node[left]{$x$};
			\draw [-latex,line width=1pt] (-4,0) coordinate ++(140:5mm) arc (-220:-140:5mm) 
			node[left]{$\Phi_i$};
			
			% Vectors
			\node at (-4,0) [text centered]{\includegraphics[scale=0.005]{figure/crashCircle}};
			\draw (-3.6,0.05) node[below]{$B$};
			\draw (-4,-3.8) node[text centered]{(a)};
			\draw (-4,3.8) node[text centered]{Front};
			
			%rotors
			\node[rotor,fill=blue,draw=blue] (n1) at (-6.2,0) {};
			\node[rotor,fill=blue,draw=blue] (n2) at (-1.8,0)  {};
			\node[rotor,fill=red,draw=red]   (n3) at (-4,-2.2) {};
			\node[rotor,fill=red,draw=red]   (n4) at (-4,2.2)  {};
			
			% archs
			\draw [latex-,line width=1pt] (n1) ++(140:5mm) arc (-220:40:5mm) node[left]{$\Omega_4$};
			\draw [-latex,line width=1pt] (n2) ++(140:5mm) arc (-220:40:5mm) node[left]{$\Omega_2$};
			\draw [latex-,line width=1pt] (n3) ++(140:5mm) arc (-220:40:5mm) node[below 
			left]{$\Omega_3$};
			\draw [-latex,line width=1pt] (n4) ++(140:5mm) arc (-220:40:5mm) node[left]{$\Omega_1$};
			...
			% Body reference system
			\draw[-latex, green, line width=1.25pt] (4,0) -- (3,0) node[below]{$y$};
			\draw[-latex, blue, line width=1.25pt] (4,0) -- (4,1) node[left]{$x$};
			\draw [-latex,line width=1pt] (4.3,0.25) coordinate ++(140:5mm) arc (-280:-180:5mm) 
			node[above left]{$\Phi_i$};
			
			% Vectors
			\node at (4,0) [text centered]{\includegraphics[scale=0.005]{figure/crashCircle}};
			\draw (4.4,0.05) node[below]{$B$};
			\draw (4,-3.8) node[text centered]{(b)};
			\draw (4,3.8) node[text centered]{Front};
			
			%rotors
			\node[rotor,fill=blue,draw=blue] (n5) at (1.8,0) {};
			\node[rotor,fill=blue,draw=blue] (n6) at (6.2,0)  {};
			\node[rotor,fill=red,draw=red]   (n7) at (4,-2.2) {};
			\node[rotor,fill=red,draw=red]   (n8) at (4,2.2)  {};
			
			% archs
			\draw [latex-,line width=1pt] (n5) ++(140:5mm) arc (-220:40:5mm) node[left]{$\Omega_4$};
			\draw [-latex,line width=1pt] (n6) ++(140:5mm) arc (-220:40:5mm) node[left]{$\Omega_2$};
			\draw [latex-,line width=1pt] (n7) ++(140:5mm) arc (-220:40:5mm) node[below 
			left]{$\Omega_3$};
			\draw [-latex,line width=1pt] (n8) ++(140:5mm) arc (-220:40:5mm) node[left]{$\Omega_1$};
...
\begin{figure}[h]
	...
	\scalebox{0.85}{
		...
		%\draw (p2) parabola (p3) parabola (p4) parabola (p5) parabola (p6) parabola (p7) parabola 
		%(p8) 
		%parabola (p9) parabola (p10);%Changed
		...
		% dots
		\draw[fill=black] (0.96,3.3) arc(-180:180:0.04);
		\draw[fill=black] (1.96,2.5) arc(-180:180:0.04);
		\draw[fill=black] (2.96,2.5) arc(-180:180:0.04);
		\draw[fill=black] (3.96,3.5) arc(-180:180:0.04);
		\draw[fill=black] (4.96,4.1) arc(-180:180:0.04);
		\draw[fill=black] (5.96,3.4) arc(-180:180:0.04);
		\draw[fill=black] (6.96,4.1) arc(-180:180:0.04);
		\draw[fill=black] (7.96,4.6) arc(-180:180:0.04);
		\draw[fill=black] (8.96,4.0) arc(-180:180:0.04);
		
		% vertical lines and labels
		\foreach \n/\texto in 
		{2/{a=x_0},3/{x_1},4/{},5/{},6/{x_{k-1}},7/{x_k},8/{},9/{x_{n-1}},10/{b=x_n}}
		{
			\draw (p\n|-0,0) -- (p\n);
...
\stepcounter{blockDiagram}	
	...
	\centering
	\scalebox{1}{
		% We would like to create a format called stardate, where dates are
		% given as ?hyear i.hday of year i?. Thus, we will enter 24th February 2259 as ?2259.55?.
		\begin{ganttchart}[
			...
			y unit chart=0.4cm, 
			bar height=0.6, 
			title label anchor/.style={below=-0.5ex},
			title left shift=.00,
			title right shift=-.00,
			title height=1,
			title label font=\small,
			bar label font=\small,
			bar/.style={fill=red!50}]{1}{12}
			...
			% bars
			\ganttbar[bar label font = \scriptsize]{Problem definition (XY)}{1}{3} \\
			\ganttbar[bar label font = \scriptsize]{MATLAB tests (XY)}{2}{4} \\
			\ganttbar[bar label font = \scriptsize]{Performance analysis (all)}{3}{4} \\
			\ganttbar[bar label font = \scriptsize]{Gazebo tests (XT + \red{?})}{4}{6} \\
			\ganttbar[bar label font = \scriptsize]{Performance analysis (all)}{5}{7} \\
			\ganttbar[bar label font = \scriptsize]{Experimental tests (XY + \red{?})}{7}{10} \\
			\ganttbar[bar label font = \scriptsize]{Performance analysis (all)}{9}{10} \\
			\ganttbar[bar label font = \scriptsize]{Working on paper (all)}{4}{4}
			\ganttbar{}{6}{6}
			\ganttbar{}{10}{12}
			
			% milestones 
			\ganttvrule[vrule/.append style={red}]{today}{1}
			\ganttvrule{L1}{3}
			\ganttvrule{L2}{6}
			\ganttvrule{L3}{10}
			\ganttvrule{L4}{12}
...
\blue{L1}: Problem definition ends. MATLAB final simulations results are coming. \\
\blue{L2}: Gazebo simulations ends. The experimental setup can be discussed. \\
\blue{L3}: Experiments campaign ends. \\
\blue{L4}: Deadline (tentative) for the XX + XX submission. 
